...
#docker exec garptea-postgres sh -c "psql -U postgres -c \"CREATE USER ${KC_DB_USER} WITH ENCRYPTED PASSWORD '${KC_DB_PASSWORD}'\""
#docker exec garptea-postgres sh -c "psql -U postgres -c \"CREATE DATABASE ${KC_DB_NAME} OWNER ${KC_DB_USER}\""
